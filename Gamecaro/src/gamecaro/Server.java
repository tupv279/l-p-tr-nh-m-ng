...
public class Server {
	...
	public Server() throws IOException {
		...
		jscroll2.getVerticalScrollBar().addAdjustmentListener(
			...
			for (int j = 0; j < y; j++) {
				...
				bt[a][b].addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (Client.flat)// new ben client click
							setEnableButton(true);
						else
							setEnableButton(false);
						bt[a][b].setIcon(new ImageIcon(
								"E:\\STUDY\\Java\\cocaro\\src\\caro\\o1.png"));
						try {
	...
	public void caro(String x, String y) {
		...
		bt[xx][yy].setIcon(new ImageIcon(
				"E:\\STUDY\\Java\\cocaro\\src\\caro\\x1.png"));
